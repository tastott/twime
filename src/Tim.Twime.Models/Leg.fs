namespace Tim.Twime.Models
    ...
    type ICyclingModel =
        ...
        abstract member WindClimbEquivalent : mass : float<kilogram> -> float<radian> -> float<meter/second> -> float<meter> -> float<meter>
...
//        }
    ...
    type AnalysedLeg(leg : Leg, legBefore : Leg, mass : float<kilogram>, model : ICyclingModel) =
        ...
        member this.WindClimbEquivalent = model.WindClimbEquivalent mass this.Bearing this.Speed this.Distance
